...
Current focus: Block 2 is done — fetch, extract, filter, score, shortlist, digest. What is left on a drafted package is mine to write.
...
1. Send the drafted applications. Packages are built; the company paragraph and the "why this company" answer still need me.
