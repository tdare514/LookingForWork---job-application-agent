...
- 399 tests pass; 1 ranking test is skipped because the corpus has no borderline label (#76). `make check` runs ruff, strict mypy, pytest and the context check. CI runs the same on push.
