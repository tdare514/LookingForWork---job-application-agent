...
| `cloudflare/` | The phone view: `public/` (static page, ADR 0009) and the proposed hosted companion (ADR 0010) — Pages Functions, D1 migrations, its own Node toolchain and tests. Nothing in `src/` imports it. |
